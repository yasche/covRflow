#' Some randomly selected albums
#'
#' Albums were selected from Apple Music's top 100 albums of all time <https://100best.music.apple.com/us>.
#'
#' @format ## `example_albums`
#' A tibble with 7 rows and 4 columns:
#' \describe{
